...
def test_dichotomy_binary_search(
    input_array: List[int], search_value: int, expected_result: int
):
    assert expected_result == dichotomy_binary_search(input_array, search_value)
